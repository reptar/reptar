...
export default class FileSystem {
  ...
  async loadIntoMemory() {
    ...
    // every path directory that isn't our source path, primarily the paths
    // defined in your config's path object.
    const ignorePatterns = _.values(Constants.ConfigFilename).concat(
