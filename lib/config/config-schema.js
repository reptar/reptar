...
const lifecycleSchema = Joi.alternatives().try(
  Joi.string(),
  Joi.func(),
...
export default Joi.object({
  ...
  middlewares: Joi.array().items(
    Joi.string(),
    Joi.func()
  ).default([]),
  lifecycle: Joi.object({
    willUpdate: lifecycleSchema,
    didUpdate: lifecycleSchema,
    willBuild: lifecycleSchema,
    didBuild: lifecycleSchema,
  }).default(),
}).default();
