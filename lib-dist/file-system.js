...
class FileSystem {
  ...
  loadIntoMemory() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      const ignorePatterns = [_constants2.default.ConfigFilename, 'package.json', 'node_modules'].concat((0, _values3.default)(_this._config.get('path')).filter(function (pathVal) {
      ...
      const filePromises = files.map(function (rawPath) {
